module AST
  ...
  class Node
    ...
    def initialize(tag_arg, type, children=[], properties={})
      set_tag(tag_arg)
    ...
    # @return [AST::Node]
    def updated(type=nil, children=nil, properties=nil)#, tag="tag_to_be_removed")
      new_type       = type       || @type
      ...
      if @type == new_type &&
        ...
        original_dup.send :initialize, "tag_to_be_removed", new_type, new_children, new_properties
      end
    end
